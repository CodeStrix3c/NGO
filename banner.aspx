<%@ Page Title="Description" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="banner.aspx.cs" Inherits="banner" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
      <div id="showcase-row">
        ...
        <div class="moduletable ">
            ...
            <asp:Image ID="kidsPhoto" runat="server" Width="100%"/>
