    ...
    protected void Bind_Grid()
    {
        ...
        if (ds.Tables[0].Rows.Count > 0)
        {
            ...
            for (i = 0; i < ds.Tables[0].Rows.Count; i++)
            {
                ...
                ltrDetails.Text += "	                <a href='eventdescription.aspx?Id=" + dr1["Id"].ToString() + "&cn=" + dr1["Title"].ToString() + "'>";
                ...
                ltrDetails.Text += "             </div>";
                ltrDetails.Text += "             <a class=\"btn btn-info readmore\" href='eventdescription.aspx?Id=" + dr1["Id"].ToString() + "&cn=" + dr1["Title"].ToString() + "'><span>Read more</span></a>";
                ltrDetails.Text += "         </div>";
                ltrDetails.Text += "      </div>";
