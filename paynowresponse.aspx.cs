...
public partial class paynowresponse : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (strorderstatus.ToLower() == "success")
        {
            try
            {
                ...
                string theSQL = "";
                theSQL += "INSERT INTO StudentPayment(dorderid, dccavenuerefno, dtrackingid, dbankrefno, studId, damount, dpaymode, dcardname, dorderdate, ispublished, isdeleted, createddate, modifieddate) VALUES(";
                theSQL += "'" + strorderno + "',";
                theSQL += "'" + strccavrefno + "',";
