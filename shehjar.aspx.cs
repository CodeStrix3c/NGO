...
public partial class shehjar : System.Web.UI.Page
{
    ...
    protected void Bind_Grid()
    {
        ...
        {
            ltrImage.Text += "<img width=\"100%\" src='Upload/" + ds.Tables[0].Rows[0]["BannerImage"].ToString() + "' class=\"lazy\" data-src='Upload/" + ds.Tables[0].Rows[0]["BannerImage"].ToString() + "' alt=\"\">";
            DataRow dr1;
            int i = 0;
