<%@ Page Title="Board Member" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="member_bio.aspx.cs" Inherits="member_bio" %>
                      ...
                      <div class="moduletable   span8">
                          <header><h3 class="moduleTitle ">
                              <span class="item_title_part0 item_title_part_odd item_title_part_first_half item_title_part_first">
                                  ...
                                  (<asp:Label ID="lblPosition" ForeColor="Black" runat="server" Text=""></asp:Label>)
                              </span> 
                            </h3>
                          </header>
