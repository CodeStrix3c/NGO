    ...
    <div class="mod-newsflash-adv mod-newsflash-adv__ cols-1" id="module_116">
         ...
         <table>
                ...
                <tr>
                    ...
                    Name :<br />
                    <asp:TextBox ID="txtCName" runat="server" CssClass="text" Width="250px"  BorderStyle="Inset"
                            MaxLength="255"></asp:TextBox><br />
                                                    <asp:RequiredFieldValidator ID="rfvCommenterName" ControlToValidate="txtCName" runat="server"
                                                        ErrorMessage="Name Required" Display="Dynamic" SetFocusOnError="true" ValidationGroup="vgComment"></asp:RequiredFieldValidator></td>
                </tr>
                
                <tr>
                    <td align="left" valign="top">
                    Mobile:<br />
                    <asp:TextBox ID="txtMContactNo" runat="server" CssClass="text" Width="250px" BorderStyle="Inset"
                ...
                <tr>
                    ...
                    Email: <br />
                    <asp:TextBox ID="txtEmailID" runat="server" CssClass="text"  Width="250px" BorderStyle="Inset"
                            MaxLength="255"></asp:TextBox><br />
                                                    <asp:RequiredFieldValidator ID="rfvEmail" runat="server" ErrorMessage="Email Required"
                                                        Display="Dynamic" SetFocusOnError="true" ControlToValidate="txtEmailID" ValidationGroup="vgComments"></asp:RequiredFieldValidator>
                ...
                <tr>
                    <td align="left" valign="top">
                    Message:<br />
                    <asp:TextBox ID="txtDescription" runat="server" Width="300px" TextMode="MultiLine"  BorderStyle="Inset"
                            Height="100px" MaxLength="1000"></asp:TextBox><br />
                             <asp:RequiredFieldValidator ID="rfvComments" runat="server" ErrorMessage="Message Required"
