<%@ Page Title="View Information" Language="C#" MasterPageFile="~/Secure/Secure.master" AutoEventWireup="true" CodeFile="View_Information.aspx.cs" Inherits="Secure_View_Information" %>
           ...
           <tr>
            ...
            <td align="left" valign="top">
              ...
              <asp:DropDownList ID="ddlPageType" runat="server" AutoPostBack="True" OnSelectedIndexChanged="ddlPageType_SelectedIndexChanged">
               <asp:ListItem Value="1">Information.aspx</asp:ListItem>
                                                <asp:ListItem Value="2">Information_P2.aspx</asp:ListItem>
                                                <asp:ListItem Value="3">Information_P3.aspx</asp:ListItem>
                                                <asp:ListItem Value="4">Information_P4.aspx</asp:ListItem>
                                                <asp:ListItem Value="5">Information_P5.aspx</asp:ListItem>
              </asp:DropDownList>
             </td>
             </tr>
            <tr>
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Information">
                                    <ItemTemplate>
                                      <div style="padding-top:10px; padding-bottom:10px">
                                        <asp:Label ID="Label1" Font-Bold="true" ForeColor="Blue" runat="server" Text='<%# Bind("Title") %>'></asp:Label><br />
                                ...
                                <asp:TemplateField HeaderText="Publish">
                                  ...
                                  <asp:TemplateField HeaderText="Edit / Delete">
                                    <ItemTemplate>
                                        <a href='Edit_Information.aspx?ID=<%#Eval("ID") %>'>
