<%@ Page Language="C#" MasterPageFile="~/Secure/Secure.master" AutoEventWireup="true" CodeFile="Add Events.aspx.cs" Inherits="FazilKashmir_Ad_Add_Events" Title="Add Events" ValidateRequest="false" %>
                            ...
                            <fieldset>
                                ...
                                <asp:Calendar ID="MyCalendar" 
                                        ...
                                        <td align="right" style="font-weight: bold" valign="top">
                                           Event Date</td>
                                        <td align="left" valign="top">
                                            <asp:TextBox ID="txtDate" runat="server" ReadOnly="true" Width="300px"></asp:TextBox>
                                         </td>
                                        </tr>
                                            <tr>
                                        <td align="right" style="font-weight: bold" valign="top">
