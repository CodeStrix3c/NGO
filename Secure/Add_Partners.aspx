<%@ Page Title="Partners" Language="C#" MasterPageFile="~/Secure/Secure.master" AutoEventWireup="true" CodeFile="Add_Partners.aspx.cs" Inherits="Secure_Add_Partners" %>
                                ...
                                <p>
                                    ...
                                    <tr>
                                      ...
                                      <td align="left" valign="top">
                                        ...
                                        <asp:RequiredFieldValidator runat="server" id="RequiredFieldValidator2" ControlToValidate="Ofile" ErrorMessage="Logo Is Required" Display="Dynamic" ValidationGroup="Writer"></asp:RequiredFieldValidator>                                       
