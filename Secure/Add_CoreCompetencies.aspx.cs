...
public partial class Secure_Add_CoreCompetencies : System.Web.UI.Page
{
    ...
    {
        string theSQL = "";
        theSQL += "INSERT INTO CoreCompetencies(Title,CreatedDate) VALUES(";
    ...
    {
        DataSet ds = obj.GetCoreCompetencies();
        Grid.DataSource = ds;
        Grid.DataBind();
    }
    ...
    {
        MsgBox.Show(obj.DeleteCoreCompetencies(Convert.ToInt32(Grid.DataKeys[e.RowIndex].Value)));
        Bind_Grid();
    }
