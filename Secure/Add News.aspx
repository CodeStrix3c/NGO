<%@ Page Language="C#" MasterPageFile="~/Secure/Secure.master" AutoEventWireup="true" CodeFile="Add News.aspx.cs" Inherits="FazilKashmir_Ad_Add_News" Title="Add News" ValidateRequest="false" %>
                            ...
                            <fieldset>
                                ...
                                <p>
                                        ...
                                        <td align="right" style="font-weight: bold" valign="top">
                                            Title</td>
                                        <td align="left" valign="top">
                                            <asp:TextBox ID="txtTitle" runat="server" Width="95%" Height="22px"></asp:TextBox>
