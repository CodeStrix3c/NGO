...
public partial class Secure_Add_RightCategoryLinks : System.Web.UI.Page
{
    ...
    {
        string theSQL = "";
        theSQL += "INSERT INTO RightLinksCategory(Title,CreatedDate) VALUES(";
    ...
    {
        DataSet ds = obj.GetRightLinksCategory();
        Grid.DataSource = ds;
        Grid.DataBind();
    }
    ...
    {
        MsgBox.Show(obj.DeleteRightLinksCategory(Convert.ToInt32(Grid.DataKeys[e.RowIndex].Value)));
        Bind_Grid();
    }
