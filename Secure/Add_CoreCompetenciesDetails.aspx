<%@ Page Title="Add Details" Language="C#" MasterPageFile="~/Secure/Secure.master" AutoEventWireup="true" CodeFile="Add_CoreCompetenciesDetails.aspx.cs" Inherits="Secure_Add_CoreCompetenciesDetails" %>
                    ...
                    <td align="left" valign="top">
                        <asp:GridView ID="Grid" runat="server" AllowPaging="True" PageSize="25" AutoGenerateColumns="False"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField>
                                    <ItemTemplate>
                                        <a href='Edit_CoreCompetenciesDetails.aspx?ID=<%#Eval("ID") %>&CatID=<%# Eval("CatId") %>'>
