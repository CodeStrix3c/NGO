...
public partial class FazilKashmir_Ad_Edit_Audios : System.Web.UI.Page
{
    ...
    {
        DataSet ds = obj.GetAudiosByID(Convert.ToInt32(Request.QueryString["ID"]));
    ...
    protected void btnSave_Click(object sender, ImageClickEventArgs e)
    {
        ...
        if (theSQL == "Success")
        {
            Response.Redirect("View_Audios.aspx");
        }
    }
}
