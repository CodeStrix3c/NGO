...
public partial class Secure_Add_ShehjarCategory : System.Web.UI.Page
{
    ...
    protected void btnSave_Click(object sender, ImageClickEventArgs e)
    {
        ...
        string theSQL = "";
        theSQL += "INSERT INTO ShehjarCategory(Title,Intro,Description,ImageUrl,BannerImage,CreatedDate) VALUES(";
        theSQL += "'" + txtTitle.Text.Replace("'", "''") + "',";
        theSQL += "'" + txtIntro.Text.Replace("'", "''") + "',";
        theSQL += "'" + txtDescription.Text.Replace("'", "''") + "',";
        theSQL += "'" + mediumImage.Replace("'", "''") + "',";
        theSQL += "'" + BannerImage.Replace("'", "''") + "',";
