<%@ Page Title="Menu Category" Language="C#" MasterPageFile="~/Secure/Secure.master" AutoEventWireup="true" CodeFile="MenuCategory.aspx.cs" Inherits="Secure_MenuCategory" %>
                        ...
                        <asp:GridView ID="Grid" runat="server" AllowPaging="True" PageSize="25" AutoGenerateColumns="False"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField  HeaderText="Add Details"> 
                                    <ItemTemplate>
                                       <a href='MenuSubCategory.aspx?CatID=<%#Eval("ID") %>'>
                                ...
                                <asp:TemplateField HeaderText="Update">
                                    <ItemTemplate>
                                        <a href='Edit_MenuCategory.aspx?ID=<%#Eval("ID") %>'>
