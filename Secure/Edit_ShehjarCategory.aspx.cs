...
public partial class Secure_Edit_ShehjarCategory : System.Web.UI.Page
{
    ...
    {
        DataSet ds = obj.GetShehjarCategoryByID(Convert.ToInt32(Request.QueryString["ID"]));
        if (ds.Tables[0].Rows.Count > 0)
        {
            ...
            for (i = 0; i < ds.Tables[0].Rows.Count; i++)
            {
                ...
                kidsPhoto.ImageUrl = "../Upload/" + dr["ImageUrl"].ToString();
                bannerImg.ImageUrl = "../Upload/" + dr["BannerImage"].ToString();
            }
        }
        else
        {
    ...
    protected void btnSave_Click(object sender, ImageClickEventArgs e)
    {
        if (Ofile.HasFile)
        {
           // string BannerImage = UploadBImage(100, 1260, 400);
            string mediumImage = UploadImage(100, 1680, 400);
            string theSQL = "";
            theSQL = " UPDATE ShehjarCategory SET";
    ...
    protected string UploadBImage(int targetSize, int Width, int Height)
    {
        string filename = "";
        try
        {
            ...
            string extension = Utility.GetPictureExtension(FileUpload1.FileName).ToUpper();
