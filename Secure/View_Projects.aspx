<%@ Page Title="View Projects" Language="C#" MasterPageFile="~/Secure/Secure.master" AutoEventWireup="true" CodeFile="View_Projects.aspx.cs" Inherits="Secure_View_Projects" %>
                    ...
                    <td align="left" valign="top">
                        <asp:GridView ID="Grid" runat="server" AllowPaging="True" PageSize="25" AutoGenerateColumns="False"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField>
                                    <ItemTemplate>
                                        <a href='Edit_Projects.aspx?ID=<%#Eval("ID") %>'>
