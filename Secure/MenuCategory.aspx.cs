...
public partial class Secure_MenuCategory : System.Web.UI.Page
{
    ...
    {
        string theSQL = "";
        theSQL += "INSERT INTO MenuCategory(Title,Description,CreatedDate) VALUES(";
    ...
    {
        DataSet ds = obj.GetMenuCategory();
        Grid.DataSource = ds;
        Grid.DataBind();
    }
    ...
    {
        MsgBox.Show(obj.DeleteMenuCategory(Convert.ToInt32(Grid.DataKeys[e.RowIndex].Value)));
        Bind_Grid();
    }
