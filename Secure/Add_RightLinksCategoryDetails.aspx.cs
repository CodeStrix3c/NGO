...
public partial class Secure_Add_RightLinksCategoryDetails : System.Web.UI.Page
{
    ...
    {
        string mediumImage = UploadImage(100, 600, 200);
        string theSQL = "";
        theSQL += "INSERT INTO RightLinksDetails(CatId,Title,Description,ImageUrl,CreatedDate) VALUES(";
    ...
    private void Bind_Grid()
    {
        ...
        DataSet ds = obj.GetRightLinksDetailsByCatSubID(Convert.ToInt32(Request.QueryString["CatID"]));
        Grid.DataSource = ds;
        Grid.DataBind();
    ...
    protected void Grid_RowDeleting(object sender, GridViewDeleteEventArgs e)
    {
        ...
        obj.DeleteRightLinksDetailsByID(Convert.ToInt32(PhotoID), Path);
