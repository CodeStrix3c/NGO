<%@ Page Language="C#" MasterPageFile="~/Secure/Secure.master" AutoEventWireup="true" CodeFile="Edit_News.aspx.cs" Inherits="FazilKashmir_Ad_Edit_News" Title="Edit News" ValidateRequest="false" %>
                                        ...
                                        <td align="left" valign="top">
                                            <asp:TextBox ID="txtIntro" runat="server" Width="95%" Height="80px" TextMode="MultiLine"></asp:TextBox>
                                             ...
                                             <tr>
                                                ...
                                                <asp:RequiredFieldValidator runat="server" id="RequiredFieldValidator1" ControlToValidate="Ofile" ErrorMessage="Image is required" Display="Dynamic" ValidationGroup="AddPhotos"></asp:RequiredFieldValidator>
                                                </td>
                                                </tr>
