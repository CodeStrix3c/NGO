<%@ Page Title="Sponsor child" Language="C#" MasterPageFile="~/Secure/Secure.master" AutoEventWireup="true" CodeFile="View_Sponsor_child.aspx.cs" Inherits="Secure_View_Sponsor_child" %>
                ...
                <tr>
                    <td align="left" valign="top">
                        <asp:GridView ID="Grid" runat="server" AllowPaging="True" PageSize="25" AutoGenerateColumns="False"
                            ...
                            <Columns>
                                <asp:TemplateField HeaderText="Sponsor A Child ">
                                      ...
                                      <tr>
                                         <td style="padding-top:10px; padding-bottom:10px">
                                          ...
                                          <asp:Label ID="lblDesignation" runat="server" Text='<%# Bind("Email") %>'></asp:Label><br />
                                           <hr style="width:450px"/>
                                            <b>Subject : </b>
                                          <asp:Label ID="Label3" runat="server" Text='<%# Bind("Subject") %>'></asp:Label><br />
                                           <hr style="width:450px"/>
                                            <b>Organization : </b>
                                          <asp:Label ID="Label4" runat="server" Text='<%# Bind("Organization") %>'></asp:Label><br />
                                           <hr style="width:450px"/>
                                          <b>Message : </b>
