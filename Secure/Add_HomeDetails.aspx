<%@ Page Title="Home Details" Language="C#" MasterPageFile="~/Secure/Secure.master" AutoEventWireup="true" CodeFile="Add_HomeDetails.aspx.cs" Inherits="Secure_Add_HomeDetails" ValidateRequest="false" %>
                            ...
                            <fieldset>
                                ...
                                <p>
                                        ...
                                        <td align="right" style="font-weight: bold" valign="top">
                                            Title</td>
                                        <td align="left" valign="top">
                                            <asp:TextBox ID="txtTitle" runat="server" Width="100%" Height="22px"></asp:TextBox>
                                         </td>
                                       </tr>
                                            <tr>
                                        <td align="right" style="font-weight: bold" valign="top">
                                            Intro</td>
                                        <td align="left" valign="top">
                                            <asp:TextBox ID="txtIntro" runat="server" Width="100%" TextMode="MultiLine" Height="80px"></asp:TextBox>
                                         </td>
                                       </tr>
