<%@ Page Title="Annual Reports" Language="C#" MasterPageFile="~/Secure/Secure.master" AutoEventWireup="true" CodeFile="Add_Annual_Reports.aspx.cs" Inherits="Secure_Add_Annual_Reports" %>

<asp:Content ID="Content1" ContentPlaceHolderID="CPH" Runat="Server">
<h3>Add Annual Reports</h3>
                        ...
                        <asp:GridView ID="Grid" runat="server" AllowPaging="True" PageSize="25" AutoGenerateColumns="False"
                            ...
                            <Columns>
                                <asp:TemplateField HeaderText="Title" HeaderStyle-Width="650px">
                                  ...
                                  <asp:TemplateField HeaderText="PDF File" HeaderStyle-Width="350px">
                                    <ItemTemplate>
                                       <a href='<%# FileURL( Eval("Url") )%>'  target="_blank">
                                       <img alt="" src="<%# getPhotos(Eval("Url"))%>" style="float:left; width:30px; height:30px; padding-right:10px"/>
                                       </a>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField>
