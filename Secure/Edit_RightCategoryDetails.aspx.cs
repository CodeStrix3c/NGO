...
public partial class Secure_Edit_RightCategoryDetails : System.Web.UI.Page
{
    ...
    {
        DataSet ds = obj.GetRightLinksDetailsByID(Convert.ToInt32(Request.QueryString["ID"]));
    ...
    {
        string theSQL = "";
        theSQL = " UPDATE RightLinksDetails SET";
        ...
        if (theSQL == "Success")
        {
            Response.Redirect("Add_RightLinksCategoryDetails.aspx?CatID=" + varID);
        }
    }
}