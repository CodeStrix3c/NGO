<%@ Page Title="Registrations" Language="C#" MasterPageFile="~/Secure/Secure.master" AutoEventWireup="true" CodeFile="View_Acep_Registrationforms.aspx.cs" Inherits="Secure_View_Acep_Registrationforms" %>
                                    ...
                                    <asp:TemplateField HeaderText="Applicant Details">
                                        <ItemTemplate>
                                                ...
                                                <tr>
                                                    <td style="width: 700px">
                                                        ...
                                                        <b>
                                                          ...
                                                          <b> Job Location :-  </b> <asp:Label ID="Label65" runat="server" Font-Size="14px" Text='<%# Bind("PreferenceDistOne") %>'></asp:Label>,
                                                         <asp:Label ID="Label66" runat="server" Font-Size="14px" Text='<%# Bind("PreferenceDistTwo") %>'></asp:Label>,
                                                         <asp:Label ID="Label67" runat="server" Font-Size="14px" Text='<%# Bind("PreferenceDistThree") %>'></asp:Label> <br />
                                            ...
                                            <table>
                                                ...
                                                <tr>
                                                    <td style="border: 1px solid #ddd;"><asp:Label ID="Label121" runat="server" Font-Size="14px" Text='<%# Bind("Position") %>'></asp:Label></td>
                                                    <td style="border: 1px solid #ddd;"><asp:Label ID="Label131" runat="server" Font-Size="14px" Text='<%# Bind("PFrom") %>'></asp:Label></td>
                                                    <td style="border: 1px solid #ddd;"><asp:Label ID="Label141" runat="server" Font-Size="14px" Text='<%# Bind("PTo") %>'></asp:Label></td>
                                                    <td style="border: 1px solid #ddd;"><asp:Label ID="Label151" runat="server" Font-Size="14px" Text='<%# Bind("GSalary") %>'></asp:Label></td>
                                                    <td style="border: 1px solid #ddd;"><asp:Label ID="Label161" runat="server" Font-Size="14px" Text='<%# Bind("Responsibilities") %>'></asp:Label></td>
                                                    <td style="border: 1px solid #ddd;"><asp:Label ID="Label171" runat="server" Font-Size="14px" Text='<%# Bind("Reasons") %>'></asp:Label></td>
                                                    <td style="border: 1px solid #ddd;"><asp:Label ID="Label181" runat="server" Font-Size="14px" Text='<%# Bind("Experience") %>'></asp:Label></td>
                                                </tr>
                                                <tr>
                                                    <td style="border: 1px solid #ddd;"><asp:Label ID="Label43" runat="server" Font-Size="14px" Text='<%# Bind("PositionOne") %>'></asp:Label></td>
                                                    <td style="border: 1px solid #ddd;"><asp:Label ID="Label44" runat="server" Font-Size="14px" Text='<%# Bind("PFromOne") %>'></asp:Label></td>
                                                    <td style="border: 1px solid #ddd;"><asp:Label ID="Label45" runat="server" Font-Size="14px" Text='<%# Bind("PToOne") %>'></asp:Label></td>
                                                    <td style="border: 1px solid #ddd;"><asp:Label ID="Label46" runat="server" Font-Size="14px" Text='<%# Bind("GSalaryOne") %>'></asp:Label></td>
                                                    <td style="border: 1px solid #ddd;"><asp:Label ID="Label47" runat="server" Font-Size="14px" Text='<%# Bind("ResponsibilitiesOne") %>'></asp:Label></td>
                                                    <td style="border: 1px solid #ddd;"><asp:Label ID="Label48" runat="server" Font-Size="14px" Text='<%# Bind("ReasonsOne") %>'></asp:Label></td>
                                                    <td style="border: 1px solid #ddd;"><asp:Label ID="Label49" runat="server" Font-Size="14px" Text='<%# Bind("ExperienceOne") %>'></asp:Label></td>
                                                </tr>
                                                <tr>
                                                    <td style="border: 1px solid #ddd;"><asp:Label ID="Label50" runat="server" Font-Size="14px" Text='<%# Bind("PositionTwo") %>'></asp:Label></td>
                                                    <td style="border: 1px solid #ddd;"><asp:Label ID="Label59" runat="server" Font-Size="14px" Text='<%# Bind("PFromTwo") %>'></asp:Label></td>
                                                    <td style="border: 1px solid #ddd;"><asp:Label ID="Label60" runat="server" Font-Size="14px" Text='<%# Bind("PToTwo") %>'></asp:Label></td>
                                                    <td style="border: 1px solid #ddd;"><asp:Label ID="Label61" runat="server" Font-Size="14px" Text='<%# Bind("GSalaryTwo") %>'></asp:Label></td>
                                                    <td style="border: 1px solid #ddd;"><asp:Label ID="Label62" runat="server" Font-Size="14px" Text='<%# Bind("ResponsibilitiesTwo") %>'></asp:Label></td>
                                                    <td style="border: 1px solid #ddd;"><asp:Label ID="Label63" runat="server" Font-Size="14px" Text='<%# Bind("ReasonsTwo") %>'></asp:Label></td>
                                                    <td style="border: 1px solid #ddd;"><asp:Label ID="Label64" runat="server" Font-Size="14px" Text='<%# Bind("ExperienceTwo") %>'></asp:Label></td>
                                                </tr>
                                            </table>
                                            ...
                                            <table>
                                                <tr>
                                                  ...
                                                  <tr>
                                                    <td style="border: 1px solid #ddd;"><asp:Label ID="Label122" runat="server" Font-Size="14px" Text='<%# Bind("LicenseNo") %>'></asp:Label></td>
                                                    <td style="border: 1px solid #ddd;"><asp:Label ID="Label132" runat="server" Font-Size="14px" Text='<%# Bind("LicenseValidity") %>'></asp:Label></td>
                                                    <td style="border: 1px solid #ddd;"><asp:Label ID="Label142" runat="server" Font-Size="14px" Text='<%# Bind("LicensePeriodTo") %>'></asp:Label></td>
                                                    <td style="border: 1px solid #ddd;"><asp:Label ID="Label152" runat="server" Font-Size="14px" Text='<%# Bind("LicenseClass") %>'></asp:Label></td>
                                                    <td style="border: 1px solid #ddd;"><asp:Label ID="Label162" runat="server" Font-Size="14px" Text='<%# Bind("LicenseAuthority") %>'></asp:Label></td>
                                                </tr>
