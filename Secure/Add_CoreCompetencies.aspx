<%@ Page Title="Core Competencies" Language="C#" MasterPageFile="~/Secure/Secure.master" AutoEventWireup="true" CodeFile="Add_CoreCompetencies.aspx.cs" Inherits="Secure_Add_CoreCompetencies" %>
                        ...
                        <asp:GridView ID="Grid" runat="server" AllowPaging="True" PageSize="25" AutoGenerateColumns="False"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField  HeaderText="Add Details"> 
                                    <ItemTemplate>
                                       <a href='Add_CoreCompetenciesDetails.aspx?CatID=<%#Eval("ID") %>'>
                                ...
                                <asp:TemplateField HeaderText="Update">
                                    <ItemTemplate>
                                        <a href='Edit_CoreCompetencies.aspx?ID=<%#Eval("ID") %>'>
