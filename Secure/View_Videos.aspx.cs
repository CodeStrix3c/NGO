...
public partial class FazilKashmir_Ad_Default2 : System.Web.UI.Page
{
       ...
       try
        {
            ...
            {
            Grid.DataSource = obj.GetVideosBySpeakerID(int.Parse(ddlSpeakers.SelectedValue.ToString()));
            Grid.DataBind();
            }
        }
        catch { }
    ...
    protected void Grid_RowDeleting(object sender, GridViewDeleteEventArgs e)
    {
        ...
        MsgBox.Show(obj.DeleteVideo(Convert.ToInt32(Grid.DataKeys[e.RowIndex].Value)));
        Bind_Grid();
    }
