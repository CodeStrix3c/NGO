<%@ Page Title="Terms & Conditions" Language="C#" MasterPageFile="~/Secure/Secure.master" AutoEventWireup="true" CodeFile="View_TermsAndConditions.aspx.cs" Inherits="Secure_View_TermsAndConditions" %>
                                ...
                                <asp:TemplateField>
                                    <ItemTemplate>
                                     ...
                                     <%--  <b style="font-size:13px">Intro</b><br />
                                        <asp:Label ID="lblMessage" runat="server" Text='<%# Bind("Intro") %>'></asp:Label><br />
                                         <a href='View_BlogComments.aspx?ID=<%#Eval("ID") %>'>
                                          View Comments
                                        </a>--%>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                   ...
                                   <asp:TemplateField>
                                    <ItemTemplate>
                                      <b style="font-size:13px">Description</b><br />
                                       <asp:Label ID="Label1" runat="server" Text='<%# Bind("Description") %>'></asp:Label><br />
                                    </ItemTemplate>
                                </asp:TemplateField>
                              
                                <asp:TemplateField>
                                    <ItemTemplate>
                                        <a href='Edit_TermsAndConditions.aspx?ID=<%#Eval("ID") %>'>
