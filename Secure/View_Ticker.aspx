<%@ Page Title="View Ticker" Language="C#" MasterPageFile="~/Secure/Secure.master" AutoEventWireup="true" CodeFile="View_Ticker.aspx.cs" Inherits="Secure_View_Ticker" %>
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Publish">
                                  ...
                                  <asp:TemplateField HeaderText="Edit / Delete">
                                    <ItemTemplate>
                                        <a href='Edit_Ticker.aspx?ID=<%#Eval("ID") %>'>
