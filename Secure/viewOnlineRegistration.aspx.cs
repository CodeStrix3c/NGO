...
public partial class Secure_viewOnlineRegistration : System.Web.UI.Page
{
    ...
    private void Bind_Grid()
    {
        ...
        DataSet ds = obj.GetOnlineRegistration();
        Grid.DataSource = ds;
        Grid.DataBind();
    ...
    protected void Grid_RowDeleting(object sender, GridViewDeleteEventArgs e)
    {
        ...
        obj.DeleteOnlineRegistration(Convert.ToInt32(ID));
