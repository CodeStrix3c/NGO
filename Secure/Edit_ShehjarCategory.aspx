<%@ Page Title="Edit Shehjar Category" Language="C#" MasterPageFile="~/Secure/Secure.master" AutoEventWireup="true" CodeFile="Edit_ShehjarCategory.aspx.cs" Inherits="Secure_Edit_ShehjarCategory" ValidateRequest="false" %>
                            ...
                            <fieldset>
                                ...
                                <table>
                                    ...
                                    <tr>
                                        <td></td>
                                        <td>
                                            <asp:Image ID="kidsPhoto" Width="200px" runat="server" />
                                             <asp:Image ID="bannerImg" Width="200px" runat="server" />
                                        </td>
                                    </tr>
                                </table>
