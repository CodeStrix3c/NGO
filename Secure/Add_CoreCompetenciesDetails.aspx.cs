...
public partial class Secure_Add_CoreCompetenciesDetails : System.Web.UI.Page
{
    ...
    {
        string mediumImage = UploadImage(100, 630, 200);
        string theSQL = "";
        theSQL += "INSERT INTO CompetenciesDetails(CatId,Title,Description,ImageUrl,CreatedDate) VALUES(";
    ...
    private void Bind_Grid()
    {
        ...
        DataSet ds = obj.GetCompetenciesDetailsByCatID(Convert.ToInt32(Request.QueryString["CatID"]));
        Grid.DataSource = ds;
        Grid.DataBind();
    ...
    protected void Grid_RowDeleting(object sender, GridViewDeleteEventArgs e)
    {
        ...
        obj.DeleteCompetenciesDetailsByID(Convert.ToInt32(PhotoID), Path);
