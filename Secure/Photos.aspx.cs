...
public partial class FazilKashmir_Ad_Default2 : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Request.QueryString["AlbumID"] == "" || Request.QueryString["AlbumID"] == null)
        {
    ...
    {
        IList li = PhotoManage.GetPhotos(Convert.ToInt32(Request.QueryString["AlbumID"]));
    ...
    protected void imgAdd_Click(object sender, ImageClickEventArgs e)
    {
        try
        {
            string smallImage = UploadImage(220);
            string mediumImage = UploadImage(100, 700, 500);
            PhotoManage.AddPhoto(Convert.ToInt32(Request.QueryString["AlbumID"]), caption.Value.Replace("'", "''"), mediumImage, smallImage);
            Bind_Grid();
            caption.Value = "";
        }
        catch (Exception exc)
    ...
    protected void GridView1_RowDeleting(object sender, GridViewDeleteEventArgs e)
    {
        ...
        PhotoManage.RemovePhoto(Convert.ToInt32(PhotoID), Path);
        GridView1.EditIndex = -1;
        Bind_Grid();
    }
    protected void GridView1_RowUpdating(object sender, GridViewUpdateEventArgs e)
    {
        ...
        PhotoManage.EditPhoto(Caption, Convert.ToInt32(PhotoID));
        GridView1.EditIndex = -1;
        Bind_Grid();
