<%@ Page Title="Add Careers" Language="C#" MasterPageFile="~/Secure/Secure.master" AutoEventWireup="true" CodeFile="Add_Careers.aspx.cs" Inherits="Secure_Add_Careers" ValidateRequest="false" %>
                            ...
                            <fieldset>
                                ...
                                <p>
                                        ...
                                        <td align="right" style="font-weight: bold" valign="top">
                                            Title</td>
                                        <td align="left" valign="top">
                                            <asp:TextBox ID="txtTitle" runat="server" Width="550px" Height="24px"></asp:TextBox>
                                      ...
                                      <td align="left" valign="top">
                                        <asp:FileUpload ID="Ofile" runat="server" Width="300px"/>
                                            ...
                                            runat="server" Text="Uplaod PDF file"  ErrorMessage="Uplaod PDF  file!" ToolTip="Uplaod PDF, DOC, JPG files Only!"
                                            ValidationExpression="^.*\.(pdf|PDF|doc|DOC|docx|DOCX|jpg|JPG)$"
                                            ControlToValidate="Ofile" Display="Dynamic" ValidationGroup="Writer"
                                        ...
                                        <p style="text-align: right;">
                                            <asp:ImageButton ID="btnSave" runat="server" CommandName="Insert" ImageUrl="../AlbumImages/button-save.gif"
                                             ValidationGroup="Writer"    onclick="btnSave_Click"  />
                                        </p>
