<%@ Page Title="Category Details" Language="C#" MasterPageFile="~/Secure/Secure.master" AutoEventWireup="true" CodeFile="Add_RightLinksCategoryDetails.aspx.cs" Inherits="Secure_Add_RightLinksCategoryDetails" ValidateRequest="false"  %>
                    ...
                    <td align="left" valign="top">
                        <asp:GridView ID="Grid" runat="server" AllowPaging="True" PageSize="25" AutoGenerateColumns="False"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField>
                                    <ItemTemplate>
                                        <a href='Edit_RightCategoryDetails.aspx?ID=<%#Eval("ID") %>&CatID=<%# Eval("CatId") %>'>
