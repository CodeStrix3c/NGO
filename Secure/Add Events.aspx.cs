...
public partial class FazilKashmir_Ad_Add_Events : System.Web.UI.Page
{
    ...
    {
        string mediumImage = UploadImage(1, 250, 200);
        string theSQL = "";
        theSQL += "INSERT INTO Events(Title,Intro,Place,Description,ImageUrl,EventDate,CreatedDate,IsActive) VALUES(";
        theSQL += "'" + txtTitle.Text.Replace("'", "''") + "',";
        theSQL += "'" + txtIntro.Text.Replace("'", "''") + "',";
        theSQL += "'" + txtPlace.Text.Replace("'", "''") + "',";
        theSQL += "'" + txtDescription.Text.Replace("'", "''") + "',";
        theSQL += "'" + mediumImage.Replace("'", "''") + "',";
        theSQL += "'" + txtDate.Text.Replace("'", "''") + "',";
        theSQL += "'" + obj.ReturnDate() + "',";
        theSQL += true;
        theSQL += ")";
        MsgBox.Show(obj.InsertEvents(theSQL));
        Reset();
    }
