...
public partial class Secure_Add_Annual_Reports : System.Web.UI.Page
{
    ...
    protected void btnSave_Click(object sender, ImageClickEventArgs e)
    {
        ...
        string theSQL = "";
        theSQL += "INSERT INTO AnnualReport(Title,Url,CreatedDate,IsPublic) VALUES(";
    ...
    private void Bind_GridAll()
    {
        ...
        DataSet ds = obj.GetAnnualReport();
        Grid.DataSource = ds;
        Grid.DataBind();
    }
    ...
    protected void Grid_RowDeleting(object sender, GridViewDeleteEventArgs e)
    {
        ...
        obj.DeleteAnnualReportByID(Convert.ToInt32(PhotoID), Path);
