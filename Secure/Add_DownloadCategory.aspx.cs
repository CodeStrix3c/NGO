...
public partial class Secure_Add_DownloadCategory : System.Web.UI.Page
{
    ...
    {
        string theSQL = "";
        theSQL += "INSERT INTO DownloadCategory(Title,Description) VALUES(";
    ...
    {
        MsgBox.Show(obj.DeleteDownloadCategory(Convert.ToInt32(Grid.DataKeys[e.RowIndex].Value)));
        Bind_Grid();
    }
