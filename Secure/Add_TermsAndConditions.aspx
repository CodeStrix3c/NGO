<%@ Page Title="Terms & Condotions" Language="C#" MasterPageFile="~/Secure/Secure.master" AutoEventWireup="true" CodeFile="Add_TermsAndConditions.aspx.cs" Inherits="Secure_Add_TermsAndConditions" ValidateRequest="false" %>
                                ...
                                <p>
                                   ...
                                   <%--  <tr>
                                        ...
                                        <td align="left" valign="top">
                                            ...
                                            <asp:RequiredFieldValidator runat="server" id="RequiredFieldValidator2" ControlToValidate="txtIntro" ErrorMessage="Intro is required" Display="Dynamic" ValidationGroup="Writer"></asp:RequiredFieldValidator>                                       
                                         </td>
                                     </tr>--%>
