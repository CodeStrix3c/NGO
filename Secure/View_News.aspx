<%@ Page Language="C#" MasterPageFile="~/Secure/Secure.master" AutoEventWireup="true" CodeFile="View_News.aspx.cs" Inherits="FazilKashmir_Ad_View_News" Title="View News" %>
                    ...
                    <td align="left" valign="top">
                        <asp:GridView ID="Grid" runat="server" AllowPaging="True" PageSize="25" AutoGenerateColumns="False"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField>
                                    <ItemTemplate>
                                        <a href='Edit_News.aspx?ID=<%#Eval("ID") %>'>
