...
public partial class Secure_View_BlogComments : System.Web.UI.Page
{
    ...
    private void Bind_Grid()
    {
        ...
        DataSet ds = obj.GetBlogCommentsByBlogId(Convert.ToInt32(Request.QueryString["ID"]));
        Grid.DataSource = ds;
        Grid.DataBind();
    ...
    protected void Grid_RowDeleting(object sender, GridViewDeleteEventArgs e)
    {
        ...
        obj.DeleteBlogComments(Convert.ToInt32(ID));
