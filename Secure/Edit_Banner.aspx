<%@ Page Title="Edit Banner" Language="C#" MasterPageFile="~/Secure/Secure.master" AutoEventWireup="true" CodeFile="Edit_Banner.aspx.cs" Inherits="Secure_Edit_Banner" ValidateRequest="false" %>
                            ...
                            <fieldset>
                                ...
                                <table>
                                    <tr>
                                        ...
                                        <td align="left" valign="top">
                                            <asp:FileUpload ID="PhotoImage" runat="server" />
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td align="left" valign="top">
                                            ...
                                            <asp:RequiredFieldValidator runat="server" ID="RequiredFieldValidator1" ControlToValidate="txtTitle" ErrorMessage="Caption is required" Display="Dynamic" ValidationGroup="AddPhotos"></asp:RequiredFieldValidator>
                                        </td>
                                    </tr>
                                    <tr>
