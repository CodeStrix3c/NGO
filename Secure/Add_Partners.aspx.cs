...
public partial class Secure_Add_Partners : System.Web.UI.Page
{
    ...
    {
        string mediumImage = UploadImage(100, 200, 150);
        string theSQL = "";
        theSQL += "INSERT INTO Partners(Title,ImageUrl,Url,CreatedDate) VALUES(";
        theSQL += "'" + txtTitle.Text.Replace("'", "''") + "',";
        theSQL += "'" + mediumImage.Replace("'", "''") + "',";
        theSQL += "'" + txtUrl.Text.Replace("'", "''") + "',";
