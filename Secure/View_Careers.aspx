<%@ Page Title="View Careers" Language="C#" MasterPageFile="~/Secure/Secure.master" AutoEventWireup="true" CodeFile="View_Careers.aspx.cs" Inherits="Secure_View_Careers" %>
                        ...
                        <asp:GridView ID="Grid" runat="server" AllowPaging="True" PageSize="25" AutoGenerateColumns="False"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField>
                                    <ItemTemplate>
                                        <br />
                                         <a href='../Upload/<%#(Eval("ImageUrl"))%>'  target="_blank">
                                         View File
                                         </a> <br />
                                ...
                                <asp:TemplateField>
                                    <ItemTemplate>
                                        <a href='Edit_Careers.aspx?ID=<%#Eval("ID") %>'>
