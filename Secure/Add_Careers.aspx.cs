...
public partial class Secure_Add_Careers : System.Web.UI.Page
{
    ...
    protected void btnSave_Click(object sender, ImageClickEventArgs e)
    {
        ...
        string filename = Ofile.FileName.ToString();
        string[] filearray = new string[2];
        filearray = filename.Split('.');
        string SaveLocation = Server.MapPath("~\\Upload") + "\\" + strGUID + "_" + Ofile.FileName;
        Ofile.PostedFile.SaveAs(SaveLocation);
        string AttachmentName = strGUID + "_" + Ofile.FileName.ToString();
        #endregion

       // string mediumImage = UploadImage(100, 1260, 400);
        string theSQL = "";
        theSQL += "INSERT INTO Careers(Title,Description,ImageUrl,CreatedDate) VALUES(";
