...
public partial class Secure_View_Ticker : System.Web.UI.Page
{
    ...
    protected void DeleteDomain(object sender, EventArgs e)
    {
        ...
        obj.DeleteTickerByID(Convert.ToInt32(ID.CommandArgument)).ToString();
        Bind_Grid();
