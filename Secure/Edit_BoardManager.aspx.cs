...
public partial class Secure_Edit_BoardManager : System.Web.UI.Page
{
    ...
    {
        DataSet ds = obj.GetBoardMembersByID(Convert.ToInt32(Request.QueryString["ID"]));
        if (ds.Tables[0].Rows.Count > 0)
        {
            ...
            for (i = 0; i < ds.Tables[0].Rows.Count; i++)
            {
                ...
                txtName.Text = dr["MName"].ToString();
    ...
    protected void btnSave_Click(object sender, ImageClickEventArgs e)
    {
        ...
        if (Ofile.HasFile)
        {
            string mediumImage = UploadImage(100, 350, 250);
            string theSQL = "";
            theSQL = " UPDATE BoardMembers SET";
            theSQL += " MName='" + txtName.Text.Replace("'", "''") + "',";
            theSQL += " Position='" + txtPosition.Text.Replace("'", "''") + "',";
            ...
            if (theSQL == "Success")
            {
                Response.Redirect("View_BoardManager.aspx");
            }
        }
        else
        {
