<%@ Page Title="Video Category" Language="C#" MasterPageFile="~/Secure/Secure.master" AutoEventWireup="true" CodeFile="Add_VideoCategory.aspx.cs" Inherits="Secure_Add_VideoCategory" %>

<asp:Content ID="Content1" ContentPlaceHolderID="CPH" Runat="Server">
<h3>Add Video Subjects</h3>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td align="left" valign="top">
                        ...
                        <asp:RequiredFieldValidator runat="server" id="RequiredFieldValidator1" ControlToValidate="txtName" ErrorMessage="Subject is required" Display="Dynamic" ValidationGroup="Writer"></asp:RequiredFieldValidator>
                    ...
                    <td align="left" valign="top">
                        <asp:GridView ID="Grid" runat="server" AllowPaging="True" PageSize="25" AutoGenerateColumns="False"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField>
                                    <ItemTemplate>
                                        <a href='Edit_VideoCategory.aspx?ID=<%#Eval("ID") %>'>
