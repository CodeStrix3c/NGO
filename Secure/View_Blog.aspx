<%@ Page Title="View Blog" Language="C#" MasterPageFile="~/Secure/Secure.master" AutoEventWireup="true" CodeFile="View_Blog.aspx.cs" Inherits="Secure_View_Blog" %>
                    ...
                    <td align="left" valign="top">
                        <asp:GridView ID="Grid" runat="server" AllowPaging="True" PageSize="25" AutoGenerateColumns="False"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField>
                                    <ItemTemplate>
                                        <a href='Edit_Blog.aspx?ID=<%#Eval("ID") %>'>
