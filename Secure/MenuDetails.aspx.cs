...
public partial class Secure_MenuDetails : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Request.QueryString["SubCatID"] == "" || Request.QueryString["SubCatID"] == null)
        {
    ...
    {
        string mediumImage = UploadImage(100, 300, 200);
        //string imageUrlLarge = DalHelpers.UploadFile(upLoadLargeImage, 900, Server.MapPath("../Upload/"));
        ...
        string imageUrlLarge = strGUID + "_" + upLoadLargeImage.FileName.ToString();
        #endregion

        string theSQL = "";
        theSQL += "INSERT INTO MenuDetails(SubCatId,Title,Description,ImageUrl,ImageUrlLarge,CreatedDate) VALUES(";
        theSQL += "'" + Convert.ToInt32(Request.QueryString["SubCatID"]) + "',";
        theSQL += "'" + txtTitle.Text.Replace("'", "''") + "',";
        theSQL += "'" + txtDescription.Text.Replace("'", "''") + "',";
        theSQL += "'" + mediumImage.Replace("'", "''") + "',";
        theSQL += "'" + imageUrlLarge.Replace("'", "''") + "',";
    ...
    private void Bind_Grid()
    {
        ...
        DataSet ds = obj.GetMenuDetailsByCatSubID(Convert.ToInt32(Request.QueryString["SubCatID"]));
        Grid.DataSource = ds;
        Grid.DataBind();
    ...
    protected void Grid_RowDeleting(object sender, GridViewDeleteEventArgs e)
    {
        ...
        obj.DeleteMenuDetailsByID(Convert.ToInt32(PhotoID), Path);
