...
public partial class Secure_Add_BoardMembers : System.Web.UI.Page
{
    ...
    protected void btnSave_Click(object sender, ImageClickEventArgs e)
    {
        ...
        string theSQL = "";
        theSQL += "INSERT INTO BoardMembers(MName,ImageUrl,Position,Description) VALUES(";
        theSQL += "'" + txtName.Text.Replace("'", "''") + "',";
        theSQL += "'" + mediumImage.Replace("'", "''") + "',";
        theSQL += "'" + txtPosition.Text.Replace("'", "''") + "',";
